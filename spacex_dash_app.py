...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
        ...
        marks={min_payload: str(min_payload), max_payload: str(max_payload)}
                                ...
                                # TASK 4: Add a scatter chart to show the correlation between payload and launch success
                                 html.Div([
        html.H3("Payload vs. Launch Success"),
...
def get_pie_chart(entered_site):
    ...
    fig = px.pie(names=['Success', 'Failed'], values=[success_count, failed_count],
...
def update_scatter_chart(selected_site, payload_range):
    ...
    fig.update_layout(title='Payload vs. Launch Success', xaxis_title='Payload Mass (kg)', yaxis_title='Launch Success')
